...
import java.math.*;
  ...
  * This class is value object representing database table cliente
...
public class Cliente implements Cloneable, Serializable {
    ...
    public void setFone(String foneIn) {
          this.fone = foneIn;
    }
    ...
    public boolean hasEqualMapping(Cliente valueObject) {
          ...
          if (this.fone == null) {
                    if (valueObject.getFone() != null)
                           return(false);
          } else if (!this.fone.equals(valueObject.getFone())) {
                    return(false);
          }
          if (this.email == null) {
    ...
    public Object clone() {
        ...
        if (this.fone != null)
             cloned.setFone(new String(this.fone)); 
        if (this.email != null)
